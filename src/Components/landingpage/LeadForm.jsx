    ...
    <div id="contact" className="w-full py-16">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2
            className="text-3xl md:text-4xl font-bold mb-4 dark:text-white text-darkbackground"
            data-aos="fade-up"
          >
            Ready to Get Started?
          </h2>
          <p
            className="max-w-2xl mx-auto dark:text-gray-300 text-gray-700"
            data-aos="fade-up"
            data-aos-delay="100"
          >
            ...
            <div className="lg:w-1/3" data-aos="fade-right">
              ...
              >
                <div className="mb-8">
                  ...
                  >
                    Reach out to us directly or fill out the form to schedule a
                    consultation.
                  </p>
                </div>
